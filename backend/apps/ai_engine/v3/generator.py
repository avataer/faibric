...
class UniversalGenerator:
    ...
    def generate(self, user_prompt: str, project_id: Optional[int] = None, max_retries: int = 2) -> Dict[str, Any]:
        """
    ...
    def _generate_with_components(self, user_prompt: str, project_id: Optional[int] = None) -> Dict[str, Any]:
        """
        ...
        """
        logger.info(f"[{project_id}] Using COMPONENT-BASED generation")
        ...
        try:
            ...
            logger.info(f"[{project_id}] Component build complete: "
                       f"required={stats['components_required']}, "
                       f"reused={stats['components_reused']}, "
                       f"generated={stats['components_generated']}")
            ...
            logger.error(f"[{project_id}] Component generation failed, falling back to legacy: {e}")
    ...
    def _generate_legacy(self, user_prompt: str, project_id: Optional[int] = None, max_retries: int = 2) -> Dict[str, Any]:
    ...
    def _parse_generation_response(self, response: str, project_id: Optional[int] = None) -> Optional[Dict[str, Any]]:
    ...
    def modify(self, current_code: str, user_request: str, project_id: Optional[int] = None) -> str:
        """
