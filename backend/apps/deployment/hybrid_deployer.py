...
class HybridDeployer:
    ...
    def deploy(
        ...
        generated_images: Dict[str, bytes] = None,  # AI-generated images to deploy
        session_token: str = None  # Session token for builder modification API
    ) -> DeploymentResult:
        """
        ...
        Args:
            ...
            generated_images: AI-generated images to deploy with the app
            session_token: Session token for the builder modification API
        ...
        # Deploy
        if provider == 'vercel':
            result = self._deploy_vercel(project_name, app_code, project_id, user_prompt, is_connector_v2, generated_images, session_token)
