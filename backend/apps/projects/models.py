...
class Project(models.Model):
    ...
    # AI Model preference - COMMENTED OUT until migration runs on production
    # MODEL_CHOICES = [
    ...
    # GitHub sync - COMMENTED OUT until migration runs on production
    ...
    def get_model_display_name(self) -> str:
        ...
        # Temporarily hardcoded until migration runs
